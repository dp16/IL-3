...
<?php while ( have_posts() ) : the_post(); ?>
		<article>
			...
			?></a></div>
					...
					<h2><a href="<?php esc_url( the_permalink() ); ?>" title="Permalink to <?php the_title(); ?>" rel="bookmark"><?php the_field('short_version_title'); ?></a></h2>

										<div class="post-info">By <?php the_author(); ?> on <?php the_time('M. j'); ?><b> |</b> <?php comments_popup_link('0 Comments', '1 Comment', '% Comments'); ?> <?php the_field('line'); ?><?php the_field('city'); ?></div>
